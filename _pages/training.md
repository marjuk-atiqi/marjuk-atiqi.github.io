...
<div class="training-card">
  <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 10px; margin-bottom: 12px;">
    ...
    <span style="background: #e2e8f0; color: #1e293b; padding: 4px 10px; border-radius: 4px; font-size: 0.85rem; font-weight: 600;">2011 &bull; 1.5 Years</span>
  </div>
  ...
  <div style="border-top: 1px solid #e2e8f0; padding-top: 12px; margin-top: 8px;">
    <strong style="color: #334155; font-size: 0.9rem; display: block; margin-bottom: 6px;">Course Details:</strong>
    <ul style="margin: 0; padding-left: 20px; color: #475569; font-size: 0.92rem; line-height: 1.6;">
      <li>Programming Practices & Techniques</li>
      <li>Fundamental of Databases</li>
      <li>Introduction to Oracle 10g: SQL</li>
      <li>Oracle 10g: Program with PL/SQL</li>
